...
function SideMenuContent({hideModal, icons}) {
    ...
    return (
        <>
            ...
            {
                icons ? <svg className="w-6 h-6 inline mr-4 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width={iconSize} height={iconSize} fill="currentColor" viewBox="0 0 24 24">
