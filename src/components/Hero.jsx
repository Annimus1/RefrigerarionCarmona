...
function Hero() {
  return (
    ...
    <section className="bg-blue-950 min-h-[95vh]">
      <div className="py-28 px-4 mx-auto max-w-screen-xl text-center lg:py-40 lg:px-12">
        
        <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-blue-100 md:text-5xl lg:text-6xl ">Refrigeración Carmona</h1>

        <p className="mb-40 lg:mb-80 sm:px-16 xl:px-48 text-4xl font-extrabold tracking-tight leading-none text-transparent md:text-5xl lg:text-6xl bg-gradient-to-tr from-white via-blue-500 to-active  bg-clip-text">El frío hecho perfección</p>
