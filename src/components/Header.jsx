    ...
    <header className="h-14 px-5 py-2 bg-gradient-to-t from-blue-500 to-blue-800 opacity-100 backdrop-blur-sm relative lg:bg-light-blue">
      <nav className="min-w-screen flex justify-between items-center">
        ...
        <div className='md:hidden'>
          <svg className="hover:cursor-pointer fill-background" onClick={handleShow} xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24"><path d="M4 6h16v2H4zm0 5h16v2H4zm0 5h16v2H4z" /></svg>
        </div>
      </nav>
